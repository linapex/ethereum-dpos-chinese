...
k.RetryInterval = int64(100 * time.Millisecond) //周期
	k.MaxRetries = 50
	k.RetryExponent = 2
	sleep := func(n int) {
		ts := k.RetryInterval
...
//testkademliacase构造kademlia和peerpot映射来验证
//提供的十六进制编码地址的建议对等和健康方法。
//参数pivotaddr是kademlia的地址。
...
/*
以下无效的Kademlia边缘案例的回归测试。

此测试中使用的地址作为仿真网络的一部分被发现
在流的高级测试中。它们是随机产生的。

=========================================================
周一-4月9日12:18:24 UTC 2018 K∧∧Mli∧Hive:皇后地址：7EFEF1
人口：9（49），MinProxBin大小：2，MinBin大小：2，MaxBin大小：4
...
=========================================================
周一-4月9日18:43:48 UTC 2018 K∧_MLI∧蜂窝：女王地址：BC7F3B
人口：9（49），MinProxBin大小：2，MinBin大小：2，MaxBin大小：4
...
=========================================================
周一-4月9日19:04:35 UTC 2018 K∧_MLI∧蜂窝：女王地址：B4822E
人口：8（49），MinProxBin大小：2，MinBin大小：2，MaxBin大小：4
...
=========================================================
周一-4月9日19:16:25 UTC 2018 K∧∧Mli∧Hive:皇后地址：9A90FE
人口：8（49），MinProxBin大小：2，MinBin大小：2，MaxBin大小：4
...
=========================================================
周一-4月9日19:25:18 UTC 2018 K∧∧Mli∧Hive:皇后地址：5DD5C7
人口：13（49），MinProxBin大小：2，MinBin大小：2，MaxBin大小：4
000 2 e528 fad0 22 fad0（0）e528（0）e3bb（0）ed13（0）
001 3 3f30 18e0 1d3 7 3f30（0）23db（0）10b6（0）18e0（0）
002 4 7C54 7804 61E4 60F9 10 61E4（0）60F9（0）636C（0）7186（0）
003 2 40ae 4bae_5 4bae（0）4d5c（0）403a（0）40ae（0）
004 0_0
005 0 3 5808（0）5a0e（0）5分贝（0）
===========深度：6=============================
