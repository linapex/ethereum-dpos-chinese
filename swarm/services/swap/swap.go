...
var (
autoCashInterval     = 300 * time.Second           //
autoCashThreshold    = big.NewInt(50000000000000)  //
autoDepositInterval  = 300 * time.Second           //
autoDepositThreshold = big.NewInt(50000000000000)  //
autoDepositBuffer    = big.NewInt(100000000000000) //
buyAt                = big.NewInt(20000000000)     //
sellAt               = big.NewInt(20000000000)     //
payAt                = 100                         //
dropAt               = 10000                       //
)
...
chequebookDeployDelay   = 1 * time.Second //
)
