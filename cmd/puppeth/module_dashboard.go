						...
						<div class="row">
							<div class="col-md-6">
								<div class="x_panel">
									...
									<div class="x_content">
<p>The Ethereum Wallet is an <a href="https://electron.atom.io/“target=”about:blank“>electron.>based desktop application to manage your ethereum accounts and funds.除了您希望执行的常规帐户生命周期操作外，钱包还提供了一种从您的帐户发送交易并与部署在网络上的智能合约进行交互的方法。<p>
...
<p>You can download the Ethereum Wallet from <a href="https://github.com/ethereum/mist/releases“target=”about:blank“>https://github.com/ethereum/mist/releases</a>。
							...
							<div class="col-md-6">
								<div class="x_panel">
									...
									<div class="x_content">
<p>The Mist browser is an <a href="https://electron.atom.io/“target=”about:blank“>electron.>based desktop application to load and interaction with ethereum-enabled third party web dapp.除了以太坊钱包提供的所有功能外，MIST是一个扩展的Web浏览器，其中加载的页面可以通过web3.js提供商访问以太坊网络，还可以与用户自己的帐户交互（给予适当的授权和确认）。<p>
...
func deploydashboard（client*sshclient，network string，conf*config，config*dashboardinfos，nocache bool）（[]字节，错误）
 ...
 如果是conf.genesis.config.ethash！= nIL{
  cppspec，err：=newcppetereumgeneisspec（网络，conf.genesis）
  如果犯错！= nIL{
   返回零
  }
